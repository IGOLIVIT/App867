            ...
            VStack {
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        Text(viewModel.selectedPlan?.plTitle ?? "")
                        ...
                        HStack {
                            ...
                            HStack {
                                ...
                                Text("\((viewModel.selectedPlan?.plDate ?? Date()).convertDate(format: "MMMM,dd"))")
                                    .foregroundColor(.white)
                        ...
                        Text(viewModel.selectedPlan?.plDescr ?? "")
                            .foregroundColor(.white)
                            .font(.system(size: 15, weight: .regular))
            ...
            ZStack {
                ...
                VStack {
                    ...
                    Button(action: {
                        ...
                        CoreDataStack.shared.deletePlan(withPlTitle: viewModel.selectedPlan?.plTitle ?? "", completion: {
